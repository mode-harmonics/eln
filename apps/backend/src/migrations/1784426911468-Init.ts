...
export class Init1784426911468 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "calendarLife" ("id" uuid NOT NULL, "experimentId" uuid NOT NULL, "attachmentId" uuid, "cellName" character varying(64) NOT NULL, "dayCount" integer NOT NULL, "q" numeric(18,6), "dq" numeric(18,6), "ddcr" numeric(18,6), "cdcr" numeric(18,6), "u" numeric(18,6), "r" numeric(18,6), "qRetention" numeric(18,6), "qRecovery" numeric(18,6), "ddcrGrowth" numeric(18,6), "cdcrGrowth" numeric(18,6), "uGrowth" numeric(18,6), "rGrowth" numeric(18,6), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_6c99ca2561ebc5cf8dd97c28907" PRIMARY KEY ("id")); COMMENT ON COLUMN "calendarLife"."id" IS '主键ID'; COMMENT ON COLUMN "calendarLife"."experimentId" IS '实验ID'; COMMENT ON COLUMN "calendarLife"."attachmentId" IS '关联附件ID'; COMMENT ON COLUMN "calendarLife"."cellName" IS '电池名称'; COMMENT ON COLUMN "calendarLife"."dayCount" IS '天数'; COMMENT ON COLUMN "calendarLife"."q" IS '定容容量(q)'; COMMENT ON COLUMN "calendarLife"."dq" IS '首次放电容量(dq)'; COMMENT ON COLUMN "calendarLife"."ddcr" IS '放电直流内阻(ddcr)'; COMMENT ON COLUMN "calendarLife"."cdcr" IS '充电直流内阻(cdcr)'; COMMENT ON COLUMN "calendarLife"."u" IS '电压(u)'; COMMENT ON COLUMN "calendarLife"."r" IS '交流内阻(r)'; COMMENT ON COLUMN "calendarLife"."qRetention" IS '容量保持率 qRetention=dq/q0d*100 (%)'; COMMENT ON COLUMN "calendarLife"."qRecovery" IS '容量恢复率 qRecovery=q/q0d*100 (%)'; COMMENT ON COLUMN "calendarLife"."ddcrGrowth" IS '放电DCR增长 ddcrGrowth=(ddcr/ddcr0d-1)*100 (%)'; COMMENT ON COLUMN "calendarLife"."cdcrGrowth" IS '充电DCR增长 cdcrGrowth=(cdcr/cdcr0d-1)*100 (%)'; COMMENT ON COLUMN "calendarLife"."uGrowth" IS '电压增长 uGrowth=(u/u0d-1)*100 (%)'; COMMENT ON COLUMN "calendarLife"."rGrowth" IS '内阻增长 rGrowth=(r/r0d-1)*100 (%)'; COMMENT ON COLUMN "calendarLife"."createdAt" IS '创建时间'`);
        ...
        await queryRunner.query(`CREATE TABLE "cellGroupMember" ("id" uuid NOT NULL, "groupId" uuid NOT NULL, "cellIdentifier" character varying(128) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ccee40464c2698ae92e5347f0a8" PRIMARY KEY ("id")); COMMENT ON COLUMN "cellGroupMember"."id" IS '主键ID'; COMMENT ON COLUMN "cellGroupMember"."groupId" IS '分组ID'; COMMENT ON COLUMN "cellGroupMember"."cellIdentifier" IS '电池标识符（cellName 或 cellId）'; COMMENT ON COLUMN "cellGroupMember"."createdAt" IS '创建时间'`);
        await queryRunner.query(`CREATE INDEX "IDX_54c9767f16a334c9f7fcab0529" ON "cellGroupMember" ("groupId") `);
        await queryRunner.query(`COMMENT ON TABLE "cellGroupMember" IS '手动分组电池表'`);
        await queryRunner.query(`CREATE TABLE "pickedCell" ("id" uuid NOT NULL, "projectId" uuid NOT NULL, "cellId" character varying(64) NOT NULL, "pickedBy" character varying(16) NOT NULL DEFAULT 'auto', "testType" character varying(64), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_cf6b7b9b12448fd5740a21b581d" PRIMARY KEY ("id")); COMMENT ON COLUMN "pickedCell"."id" IS '主键ID'; COMMENT ON COLUMN "pickedCell"."projectId" IS '项目ID'; COMMENT ON COLUMN "pickedCell"."cellId" IS '电池编号'; COMMENT ON COLUMN "pickedCell"."pickedBy" IS '挑选方式(auto/manual)'; COMMENT ON COLUMN "pickedCell"."testType" IS '分配的测试类型'; COMMENT ON COLUMN "pickedCell"."createdAt" IS '创建时间'`);
